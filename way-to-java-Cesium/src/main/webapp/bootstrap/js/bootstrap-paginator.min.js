    ...
    function($) {
        ...
        BootstrapPaginator.prototype = {
            ...
            render: function() {
                ...
                for (this.$element.addClass(containerClass),
                         this.$element.empty(),
                     ...
                     pages.prev && (prev = this.buildPageItem("prev", pages.prev), prev && listContainer.append(prev)), i = 0; i < pages.length; i += 1) p = this.buildPageItem("page", pages[i]),
