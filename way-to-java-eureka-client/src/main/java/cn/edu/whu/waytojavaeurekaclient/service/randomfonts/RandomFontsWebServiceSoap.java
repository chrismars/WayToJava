...
public interface RandomFontsWebServiceSoap {
     ...
     * @param byFontsLength
     * @return
     *     returns cn.edu.whu.waytojavaeurekaclient.service.randomfonts.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getChineseFonts", targetNamespace = "http://WebXml.com.cn/", className = "cn.edu.whu.waytojavaeurekaclient.service.randomfonts.GetChineseFonts")
    @ResponseWrapper(localName = "getChineseFontsResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.edu.whu.waytojavaeurekaclient.service.randomfonts.GetChineseFontsResponse")
    ...
    @RequestWrapper(localName = "getCharFonts", targetNamespace = "http://WebXml.com.cn/", className = "cn.edu.whu.waytojavaeurekaclient.service.randomfonts.GetCharFonts")
    @ResponseWrapper(localName = "getCharFontsResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.edu.whu.waytojavaeurekaclient.service.randomfonts.GetCharFontsResponse")
