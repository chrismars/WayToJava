...
public interface QqOnlineWebServiceSoap {
    ...
    @RequestWrapper(localName = "qqCheckOnline", targetNamespace = "http://WebXml.com.cn/", className = "cn.edu.whu.waytojavaeurekaclient.service.qqonline.QqCheckOnline")
    @ResponseWrapper(localName = "qqCheckOnlineResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.edu.whu.waytojavaeurekaclient.service.qqonline.QqCheckOnlineResponse")
